...
require (
	...
	github.com/grafana/grafana-app-sdk v0.56.5 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana-app-sdk/logging v0.56.5 // @grafana/grafana-app-platform-squad
